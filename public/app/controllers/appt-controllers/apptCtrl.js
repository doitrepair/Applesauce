...
angular.module('apptCtrl', ['acmeService', 'filters', 'submitService', 'infoService'])
	.controller('apptController', function($scope, $location, userData, apptData, netIdFactory, submitFactory, $mdDialog) {
		...
		$scope.showConfirm = function(ev, item, this_week) {
			...
			var confirm = $mdDialog.confirm()
						.title('You are about to schedule an appointment for ' +item.day + ", " + item.friendly_date + " at " + item.time+ '.')
						.textContent('To confirm your appointment on '+item.day + ", " + item.friendly_date + " at " + item.time+", press CONTINUE.")
						.ariaLabel('Lucky day')
						.targetEvent(ev)
